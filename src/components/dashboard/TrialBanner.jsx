    ...
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <Link
          ...
          className="bg-white text-primary-600 px-6 py-3 rounded-full font-bold hover:shadow-2xl transition-all hover:scale-105 flex items-center gap-2 whitespace-nowrap"
        >
